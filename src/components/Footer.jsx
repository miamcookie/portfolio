    ...
    <footer className="footer">
      <div className="footer__inner">
        ...
        <div className="footer__links">
          <a href="mailto:chen.mickbut@gmail.com" className="footer__link" aria-label="Email">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
              <rect x="2" y="4" width="20" height="16" rx="2"/>
              <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
          </a>
          <a href="https://github.com/miamcookie" target="_blank" rel="noreferrer" className="footer__link" aria-label="GitHub">
          ...
          <a href="tel:0751904565" className="footer__link" aria-label="Téléphone">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
